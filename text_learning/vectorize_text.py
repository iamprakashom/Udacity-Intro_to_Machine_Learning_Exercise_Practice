...
vec_word_data = vectorizer.fit_transform(word_data)
vocab_list = vectorizer.get_feature_names()
print "How many different words (Features) are there?", len(vocab_list)
print "What is word number 34597 in your TfIdf?", vocab_list[34597]
